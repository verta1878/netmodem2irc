...
uses
  ...
  Forms, Dialogs, StdCtrls, ExtCtrls, LCLType,
...
uses
  ...
  MD5, InstFunc, SelFolderForm, Extract, Logging, RestartManager, FPCCompat, LResources;
...
{$IFDEF IS_D7}
  { MainPanel.ParentBackground removed for LCL }
{$ENDIF}
