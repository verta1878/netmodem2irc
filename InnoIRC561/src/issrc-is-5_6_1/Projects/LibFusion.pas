...
uses
  ActiveX, SysUtils, Windows, CmnFunc2;

type
  IAssemblyCache = interface(IUnknown)
    function UninstallAssembly(dwFlags: Integer; pszAssemblyName: PWideChar; pvReserved: Integer; var pulDisposition: Integer): Integer; stdcall;
    function QueryAssemblyInfo(dwFlags: Integer; pszAssemblyName: PWideChar; pAsmInfo: Integer): Integer; stdcall;
    function CreateAssemblyCacheItem(dwFlags: Integer; pvReserved: Integer; var ppAsmItem: Integer; pszAssemblyName: PWideChar): Integer; stdcall;
    function CreateAssemblyScavenger(var ppAsmScavenger: Pointer): Integer; stdcall;
    function InstallAssembly(dwFlags: Integer; pszManifestFilePath: PWideChar; pvReserved: Integer): Integer; stdcall;
  end;
