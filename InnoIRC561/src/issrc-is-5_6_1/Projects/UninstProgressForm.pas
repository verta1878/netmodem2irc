...
uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, LCLType, Dialogs,
...
uses
  TaskbarProgressFunc, Main, Msgs, MsgIDs, CmnFunc, LResources;
...
{$IFDEF IS_D7}
  { MainPanel.ParentBackground - not in LCL }
{$ENDIF}
