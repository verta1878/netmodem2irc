...
uses
  Windows, SysUtils, Messages, Classes, Graphics, Controls, Forms, Dialogs, LCLType,
  UIStateForm, MsgIDs;
...
var
  ...
  TMA: record
    ...
    tmFirstChar, tmLastChar, tmDefaultChar, tmBreakChar: AnsiChar;
...
begin
  ...
  try
    ...
    Windows.GetTextMetricsA(DC, @TMA);
    Y := TMA.tmHeight;
  finally
    ReleaseDC(0, DC);
  end;
