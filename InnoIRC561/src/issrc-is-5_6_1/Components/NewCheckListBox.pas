...
uses
  ...
  StdCtrls, UxThemeISX, LMessages, LCLType;
...
type
  ...
  public
    ...
    { procedure CreateWindowHandle - not in LCL, moved to CreateWnd }
  ...
  published
    ...
    property Color;
    { property Ctl3D; } { not in LCL }
    { property DragCursor; } { not in LCL }
    property DragMode;
    property Enabled;
    ...
    { property ParentCtl3D; } { not in LCL }
    property ParentFont;
...
{ CreateWindowHandle removed for LCL - UpdateThemeData called from CreateWnd }
...
procedure TNewCheckListBox.MeasureItem(Index: Integer; var AHeight: Integer);
var
...
begin
  with Canvas do begin
    ...
    if ItemState.MeasuredHeight < FMinItemHeight then
      AHeight := FMinItemHeight
    else
      AHeight := ItemState.MeasuredHeight + 4;
