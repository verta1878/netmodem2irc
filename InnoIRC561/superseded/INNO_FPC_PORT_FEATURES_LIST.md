...
>
> Per-phase gap list written against the pre-Phase-4 hollow build. The six
> work items it tracks (LZMA, resources, forms, PascalScript, IDE,
> SetupCompat) were all completed in Phases 4-8.
>
