> **HISTORICAL — superseded 2026-07-25.**
>
> Two caveats before using this file:
>
> 1. **Its phase numbering is obsolete and conflicts with the current
>    scheme.** This doc has 4=Setup.exe Runtime, 5=Component Controls,
>    6=GUI Wizard. Canonical is 4=LZMA, 5=Resources, 6=DFM->LFM. Only
>    phases 7 and 8 agree. Use `../README.md` for phase numbers.
> 2. **Its status marks predate Phases 4-8.** Entries marked stubbed
>    (`uPS*.pas`, `SetupCompat.pas`, LZMA) have since been implemented.
>
> The file-by-file audit of FPC compatibility changes (`Application.Handle`
> -> `GetAppHandle`, `Ole2` -> `ActiveX`, `CompareFileTime` pointers, etc.)
> is still accurate and remains the reason to keep this doc.
>
