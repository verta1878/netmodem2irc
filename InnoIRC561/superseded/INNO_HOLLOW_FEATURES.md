...
>
> Describes the pre-Phase-4 hollow build: PascalScript as 22 stub files
> (~410 lines vs ~5,669 original), LZMA decompression stubbed to return 0,
> all 13 DFM forms disabled, 12 `.res` directives off, SetupCompat at 24
> lines. **Phases 4-8 fixed every item on this list.** Kept as the record
> of what the stub-era build looked like.
>
