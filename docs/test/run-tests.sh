...
for u in NM_UART16550 NM_Fossil NetTransport NM_ATCommand NM_Node NM_NamedPipeLink NM_ServerBridge NM_FossilDriver; do
...
echo "=== running tests ==="
fails=0
for t in test_uart test_fossil test_transport test_atcommand test_synapse_stub test_node test_pipelink test_pipe_transport test_bridge test_bridge_io test_m1_complete test_fossildriver test_at_extended test_inbound; do
