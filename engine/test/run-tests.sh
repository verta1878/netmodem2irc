...
for u in NM_UART16550 NM_Fossil NetTransport NM_ATCommand NM_Node NM_NamedPipeLink NM_ServerBridge NM_FossilDriver NM_SeamProtocol NM_SeamSender NM_TSR NM_Config NM_ConfigApply NM_DefaultConfig NM_GlobalConfig NM_Listserv NM_AutoNews NM_ServerLink; do
